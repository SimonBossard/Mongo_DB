...
#### Requêtes mongoDB pour réaliser les cartes :
...
##### Le nombre de créneaux carte 2 :

db.dump_Jan2022.aggregate([{\$unwind:"\$visit_motives"},
{\$unwind:"$visit_motives.slots"},
{\$match:{"visit_motives.name":/^1re/}},
{\$match:{"visit_motives.slots":{"\$gte":ISODate("2022-01-01T00:00:00Z")},
"visit_motives.slots":{"\$lt":ISODate("2022-06-02T00:00:00Z")}}},
